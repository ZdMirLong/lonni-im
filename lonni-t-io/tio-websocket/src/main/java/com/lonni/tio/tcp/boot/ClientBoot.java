...
import com.lonni.tio.msg.HelloPacket;
import com.lonni.tio.tcp.handler.HelloClientAioHandler;
 ...
 *
 * @author: Lonni
 * @date: 2023/2/22 0022 14:24
 */
public class ClientBoot implements Serializable {

    //服务器节点
    public static Node serverNode = new Node("127.0.0.1",9776);
